          ...
          const response = await fetch('/api/chat', {
            ...
            body: JSON.stringify({
              messages: [
                ...
                {
                  role: 'user',
                  content: `Please provide a brief definition of "${selectedText}" in the context of our conversation.`
                }
              ],
              isQuickDefinition: true // Add flag to identify quick definition requests
            })
          });
